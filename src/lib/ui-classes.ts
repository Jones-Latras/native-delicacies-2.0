export const UI_FIELD_LABEL_CLASS =
  "mb-2 block text-[0.7rem] font-medium uppercase tracking-[0.22em] text-latik/78";

export const UI_FIELD_BASE_CLASS =
  "w-full rounded-[var(--radius-card)] border border-latik/35 bg-asukal/90 px-4 py-3 text-sm text-kape shadow-[inset_0_1px_0_rgba(255,255,255,0.45)] transition-all duration-300 ease-in-out placeholder:text-latik/45 focus:border-pandan focus:outline-none focus:ring-2 focus:ring-pandan/25 disabled:cursor-not-allowed disabled:bg-gatas/70 disabled:opacity-60";

export const UI_FIELD_ERROR_CLASS =
  "mt-1.5 text-[0.68rem] font-medium uppercase tracking-[0.16em] text-red-800/85";
export const UI_FIELD_ERROR_STATE_CLASS =
